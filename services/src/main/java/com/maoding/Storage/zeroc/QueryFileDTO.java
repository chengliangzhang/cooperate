...
public class QueryFileDTO implements java.lang.Cloneable,
                                     java.io.Serializable
{
    ...
    public QueryFileDTO(String statusAttr, String passDesign, String passCheck, String passAudit, String nodeTypeAttr, String isDesign, String isCA, String isCommit, String isHistory, String userId, String roleAttr, String isTaskLeader, String isTaskDesigner, String isTaskChecker, String isTaskAuditor, String actionAttr, String askCA, String askCommit)
    {
        this.statusAttr = statusAttr;
        this.passDesign = passDesign;
        this.passCheck = passCheck;
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        QueryFileDTO r = null;
        if(rhs instanceof QueryFileDTO)
        {
            r = (QueryFileDTO)rhs;
        }
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::zeroc::QueryFileDTO");
    ...
    public QueryFileDTO clone()
    {
        QueryFileDTO c = null;
        try
        {
            c = (QueryFileDTO)super.clone();
        }
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, QueryFileDTO v)
    {
        if(v == null)
        {
    ...
    static public QueryFileDTO ice_read(com.zeroc.Ice.InputStream istr)
    {
        QueryFileDTO v = new QueryFileDTO();
        v.ice_readMembers(istr);
        return v;
    }

    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Optional<QueryFileDTO> v)
    {
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, QueryFileDTO v)
    {
    ...
    static public java.util.Optional<QueryFileDTO> ice_read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            return java.util.Optional.of(QueryFileDTO.ice_read(istr));
        }
        else
        {
    ...
    private static final QueryFileDTO _nullMarshalValue = new QueryFileDTO();

    public static final long serialVersionUID = 479148420L;
}
