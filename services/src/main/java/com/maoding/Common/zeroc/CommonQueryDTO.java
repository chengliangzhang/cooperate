...
public class CommonQueryDTO implements java.lang.Cloneable,
                                       java.io.Serializable
{
    ...
    public CommonQueryDTO(String id, String name, String typeId, String projectId, String issueId, String taskId, String companyId, String lastModifyUserId, String lastModifyRoleId, String accountId, long startTimeStamp, long endTimeStamp, String fuzzyId)
    {
        this.id = id;
        this.name = name;
        this.typeId = typeId;
    ...
    public boolean equals(java.lang.Object rhs)
    {
        ...
        CommonQueryDTO r = null;
        if(rhs instanceof CommonQueryDTO)
        {
            r = (CommonQueryDTO)rhs;
        }
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::zeroc::CommonQueryDTO");
    ...
    public CommonQueryDTO clone()
    {
        CommonQueryDTO c = null;
        try
        {
            c = (CommonQueryDTO)super.clone();
        }
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, CommonQueryDTO v)
    {
        if(v == null)
        {
    ...
    static public CommonQueryDTO ice_read(com.zeroc.Ice.InputStream istr)
    {
        CommonQueryDTO v = new CommonQueryDTO();
        v.ice_readMembers(istr);
        return v;
    }

    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Optional<CommonQueryDTO> v)
    {
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, CommonQueryDTO v)
    {
    ...
    static public java.util.Optional<CommonQueryDTO> ice_read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.FSize))
        {
            istr.skip(4);
            return java.util.Optional.of(CommonQueryDTO.ice_read(istr));
        }
        else
        {
    ...
    private static final CommonQueryDTO _nullMarshalValue = new CommonQueryDTO();

    public static final long serialVersionUID = 946420653L;
}
