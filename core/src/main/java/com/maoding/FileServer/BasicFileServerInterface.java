...
public interface BasicFileServerInterface {
    ...
    default BasicFileMultipartDTO readFile(BasicFileDTO file, long pos, int size) {
        return null;
    }
    ...
    default BasicFileDTO moveFile(BasicFileDTO src, BasicFileDTO dst) {
        return src;
    }

    default long getFileLength(BasicFileDTO basicSrc) {
        return 0;
    }

    default boolean setFileLength(BasicFileDTO basicSrc, long fileLength) {
        return true;
    }

    default BasicFileDTO copyFile(BasicFileDTO basicSrc, BasicFileDTO basicDst) {return null;}
}
